    ...
    <>
      <form name='cadastroForm' id='cadastroForm' method='post'>
        <div className='panel-group' id='accordion'>
          ...
          <div className='panel panel-primary' ng-hide='escondePaciente'>
            <div id='collapse2' className='panel-collapse collapse'>
              <div className='panel-body'>
                <div className='form-group col-sm-3'>
                  <input type='radio' id='ocorrencia1' name='ocorrencia' />{" "}
                  Atendimento Clínico
                </div>
                <div className='form-group col-sm-3'>
                  <input type='radio' id='ocorrencia2' name='ocorrencia' />{" "}
                  Acidente de Trabalho
                </div>
                <div className='form-group col-sm-3'>
                  <input type='radio' id='ocorrencia3' name='ocorrencia' />{" "}
                  Acidente de Trânsito
                </div>
                <div className='form-group col-sm-3'>
                  <input type='radio' id='ocorrencia4' name='ocorrencia' />{" "}
                  Gestante
                </div>
                <div className='form-group col-sm-12'>
                  <input type='radio' id='ocorrencia5' name='ocorrencia' />{" "}
                  Outros
                  <input
                    type='text'
              ...
              <div className='panel-footer text-center'>
                <button className='btn btn-success' ng-click='concluir()'>
                  Concluir
                </button>
              </div>
            </div>
